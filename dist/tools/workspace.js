...
import { CreateModSchema, InspectModSchema, ListModFilesSchema, ReadModFileSchema, WriteModFileSchema, DeleteModFileSchema, RenameModFileSchema, ValidateModSchema, GetModDependenciesSchema, GetProjectStatusSchema, } from "../schemas.js";
...
export const workspaceTools = [
    {
        ...
        description: "Create a new Project Zomboid mod project with proper B42/B41 structure including mod.info, directory layout, and placeholder files",
        inputSchema: CreateModSchema,
        handler: async (args, ctx) => {
            const { name, id, author, description, version, template, targetDir, createLuaFolder, createSoundFolder, createTexturesFolder, } = args;
            ...
            try {
                ...
                throw new McpError(ErrorCode.InvalidParams, `Invalid targetDir: ${err.message}`);
            }
    ...
    },
    {
        ...
        description: "Inspect a mod's structure, returning detailed information about files, metadata, build versions, and content types",
    ...
    },
    {
        ...
        description: "List all files in a mod directory with optional filtering by type (script, lua, asset, etc.) or pattern",
    ...
    },
    {
        ...
        description: "Read the contents of a file from a mod directory. Path must be relative to mod root.",
    ...
    },
    {
        ...
        description: "Write/create a file in a mod directory. Requires explicit overwrite flag for existing files. Creates backup if requested.",
    ...
    },
    {
        ...
        description: "Delete a file from a mod directory. Protects critical files like mod.info. Optional backup creation.",
    ...
    },
    {
        ...
        description: "Rename/move a file within a mod directory. Both paths must be relative to mod root.",
    ...
    },
    {
        ...
        description: "Validate a mod's structure, checking for required files, proper metadata, and common issues",
    ...
    },
    {
        ...
        description: "Extract and report mod dependencies from mod.info (require and incompatible lists)",
    ...
    },
    {
        ...
        description: "Get comprehensive project status including metadata, structure, validation, dependencies, and issues",
