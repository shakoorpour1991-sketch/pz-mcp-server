...
export function toMcpError(error) {
    if (error instanceof ZodError) {
        return new McpError(ErrorCode.InvalidParams, `Invalid parameters: ${error.errors
    ...
    return new McpError(ErrorCode.InternalError, `Tool execution failed: ${sanitizeErrorMessage(message)}`);
}
