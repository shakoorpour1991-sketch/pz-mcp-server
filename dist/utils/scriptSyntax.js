 ...
 */
export function matchPropertyLine(line, separator) {
 ...
 */
export function parseScriptValue(value) {
    // Remove quotes
 ...
 */
export function formatScriptValue(value) {
...
//# sourceMappingURL=scriptSyntax.js.map