...
Technique: Uses cubic Hermite splines to define track curvature. The graph structure allows for efficient pathfinding (
O
(
E
+
...
O(E+V)) when determining valid routes for switches.
lua
