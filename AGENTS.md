...
| Tests (build + node:test) | `npm test` — 497 tests, 101 suites, must stay green |
| Lint                      | `npm run lint`                                     |
...
- Workspace status (Aug 2026): 497/497 tests green (node:test runner, 101 suites), lint+build clean, `npm audit` 0 vulnerabilities.
