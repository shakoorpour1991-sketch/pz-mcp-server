...
| Tests (build + node:test) | `npm test` — 460 tests, 96 suites, must stay green |
| Lint                      | `npm run lint`                                     |
...
- Workspace status (Aug 2026): 460/460 tests green (node:test runner, 96 suites), lint+build clean, `npm audit` 0 vulnerabilities.
